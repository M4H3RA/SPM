...
def thex(s):
    for c in s + '\n':
        ...
        time.sleep(1./12)
def selesai():
    print ("Bye Tod Jangan Lupa Bahagia:v")
    time.sleep(1)
    sys.exit()
def kembali():
...
"""
print (banner)
print ("\033[1;97m[\033[1;91mNOTE!!\033[1;97m]\033[037mSpam Tidak Terbatas && Author tidak bertanggung jawab atas apa yg anda lakukan\n\033[90mCtrl+z \033[1;97mUntuk Stop\033[1;91m!!!")
s = requests.Session()
...
print ("\x1b[1;92mSabarAnjing\x1b[1;97m")
thex(">>>>>>>>>>>>>>>>>>>>>>")
while True:
